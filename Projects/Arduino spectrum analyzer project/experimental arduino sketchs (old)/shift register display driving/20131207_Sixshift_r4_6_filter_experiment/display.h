...
void init_display()
{
  ...
  // set up display interrupt on TIMER0_COMPA_vect
  ...
  // The low three bits of TCCR0B specify the clock source and are as follows
  // 0 : disabled
  ...
  // We use a prescaler of 8
  TCCR0B  = 0b00000010;

  // Trigger a display interrupt every OCR0A ticks
  OCR0A = 150;
